...
class Arthur_AI_Action_Change_Login_Button_Colors implements Arthur_AI_Action_Interface {
    ...
    public function execute( array $payload ) {
        $button_background      = isset( $payload['button_background'] ) ? $payload['button_background'] : '';
        $button_text            = isset( $payload['button_text'] ) ? $payload['button_text'] : '';
        $button_hover_background = isset( $payload['button_hover_background'] ) ? $payload['button_hover_background'] : '';
        $button_hover_text      = isset( $payload['button_hover_text'] ) ? $payload['button_hover_text'] : '';
