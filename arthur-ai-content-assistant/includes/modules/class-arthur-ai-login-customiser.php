...
class Arthur_AI_Login_Customiser {
    ...
    /**
     * Output CSS for logo, background, form, buttons, alignment and custom CSS.
     */
    public static function output_login_styles() {
        ...
        $bg_colour_css = $bg_colour ? sanitize_hex_color_no_hash( $bg_colour ) : '';
        if ( $bg_colour_css ) {
            $bg_colour_css = '#' . $bg_colour_css;
        }
    ...
    public static function filter_login_message( $message ) {
        ...
        return '<p class="arthur-ai-login-message" style="text-align: center; margin-bottom: 16px;">' . $welcome . '</p>' . $message;
    }
    ...
    public static function output_login_footer() {
        ...
        echo '<p class="arthur-ai-login-footer" style="text-align: center; margin-top: 24px;">' . wp_kses_post( $footer ) . '</p>';
    }
    ...
    /**
     * Override the logo title attribute if needed (optional).
     */
